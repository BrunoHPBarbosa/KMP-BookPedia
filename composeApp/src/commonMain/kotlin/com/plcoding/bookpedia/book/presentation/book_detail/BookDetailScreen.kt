...
import com.plcoding.bookpedia.book.presentation.book_detail.components.BlurredImageBackgound
...
private  fun BookDetailScreen(
    ...
    BlurredImageBackgound(
        imageUrl = state.book?.imgUrl,
        isFavorite = state.isFavorite,
        onFavoriteClick = {
            onAction(BookDetailAction.OnFavoritelick)
        },
        onBackClick = {
